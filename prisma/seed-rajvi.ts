...
// ─── Fixed IDs ────────────────────────────────────────────────
const STORE_ID   = "rajvi-store-0000-0000-0000-000000000002";
...
async function main() {
  ...
  const billboards = [
    {
      ...
      imageURL: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=1400&auto=format&fit=crop&q=85",
    },
    {
      id: BB.beds,
      label: "Luxury Beds — Sleep Like Never Before",
      imageURL: "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=1400&auto=format&fit=crop&q=85",
    },
    {
      id: BB.mattresses,
      label: "Memory Foam & Spring Mattresses — Best Prices in Surat",
      imageURL: "https://images.unsplash.com/photo-1540518614846-7eded433c457?w=1400&auto=format&fit=crop&q=85",
    },
  ];
  ...
  const filterItems = [
    ...
    { id: FI.leather, name: "Leather", value: "Leather", filterId: FIL.material },
  ...
  const products = [
    ...
    },
    {
      ...
      measurements: "Long side: 98\" | Short side: 60\" | Depth: 38\" | Seat height: 17\"",
      materialsAndCare: "Frame: Kiln-dried mango wood\nUpholstery: Premium linen-blend fabric\nFilling: Pocket spring + HR foam",
    ...
    // ── Sofa Cum Bed ──
    {
      ...
      measurements: "Sofa mode: 78\"W × 34\"D × 36\"H\nBed mode: 78\"W × 54\"D (full double size)\nMattress thickness: 4 inches",
      materialsAndCare: "Frame: Powder-coated steel + engineered wood\nUpholstery: Easy-clean microfiber fabric\nMattress: Foam\n\nCare: Spot clean only. Do not machine wash covers.",
      assembly: "Pull the seat cushion forward and lift the backrest to reveal the fold-out frame. The bed unfolds on smooth metal rails. Reverse to return to sofa mode.",
    ...
    // ── Beds ──
    {
      ...
      measurements: "Outer: 84\"W × 90\"L × 42\"H\nInner sleeping area: 72\"W × 78\"L\nStorage depth: 12 inches",
      materialsAndCare: "Frame: Engineered wood with walnut veneer\nHeadboard: MDF with upholstered fabric panel\nStorage: Hydraulic gas lift mechanism (rated 80 kg)\n\nCare: Wipe with dry cloth. Avoid moisture near wood edges.",
      assembly: "Assembled by our delivery team at no extra charge within Surat. Outside Surat — assembly charges applicable.",
    ...
    },
    {
      ...
      measurements: "King outer: 84\"W × 90\"L × 50\"H\nHeadboard height: 50\" from floor",
  ...
  for (const product of products) {
    ...
    await prisma.productOnFilterItem.deleteMany({ where: { productId: product.id } });
